...
/**
 * Adapted from the built in Servo class
 *
 * <p>
 ...
 */
public class RatchetServo extends PWM {
  ...
  public RatchetServo(final int channel) {
    super(channel);
    setBoundsMicroseconds(kDefaultMaxServoPWM, 1, 1500, 1, kDefaultMinServoPWM);
   ...
   * Servo values range from 0.0 to 1.0 corresponding to the range of full left to
   * full right.
   * This returns the commanded position, not the position that the servo is
   * actually at, as the
